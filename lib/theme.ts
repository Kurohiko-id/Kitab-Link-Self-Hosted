...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  {
    // buttonSurface "pixel" (hard offset shadow, gak ada blur) udah persis efek khas
    // neobrutalism -- tinggal dipasangin border tebel + warna flat kontras tinggi +
    // font geometric bold, gak butuh ButtonSurface baru.
    id: "brutalism",
    name: "Brutalism",
    description: "Bold flat blocks, thick border, hard shadow",
    tokens: {
      backgroundType: "solid",
      backgroundColors: ["#f2f2ed"],
      backgroundImage: null,
      text: "#111111",
      textMuted: "#3f3f3f",
      textShadow: false,
      textBackdrop: false,
      cardBackground: "#ffd60a",
      cardBorder: "#111111",
      buttonText: "#111111",
      fontFamily: "space-grotesk",
      fontSize: 16,
  ...
  {
    // Varian warna dari "brutalism" di atas -- mekanisme SAMA PERSIS (buttonSurface
    // "pixel", background netral + tombol satu warna aksen), cuma diganti mint.
    id: "brutalism-mint",
    name: "Brutalism Mint",
    description: "Mint green blocks, thick border, hard shadow",
    tokens: {
      backgroundType: "solid",
      // Krem hangat (dipake di preset kuning) gak nyambung sama mint yang dingin --
      // putih di-tint tipis ke mint biar tetep harmonis, bukan bentrok.
      backgroundColors: ["#eef9f1"],
      backgroundImage: null,
      text: "#111111",
      textMuted: "#3f3f3f",
      textShadow: false,
      textBackdrop: false,
      cardBackground: "#8ADE9D",
      cardBorder: "#111111",
      buttonText: "#111111",
      fontFamily: "space-grotesk",
      fontSize: 16,
  ...
  {
    // Varian warna dari "brutalism" -- background netral + tombol Alpine Blue.
    id: "brutalism-blue",
    name: "Brutalism Alpine Blue",
    description: "Alpine blue blocks, thick border, hard shadow",
    tokens: {
      backgroundType: "solid",
      // Sama alasannya kayak varian mint -- putih di-tint tipis ke biru, bukan krem hangat.
      backgroundColors: ["#eef8fd"],
      backgroundImage: null,
      text: "#111111",
      textMuted: "#3f3f3f",
      textShadow: false,
      textBackdrop: false,
      cardBackground: "#40B6ED",
      cardBorder: "#111111",
      buttonText: "#111111",
      fontFamily: "space-grotesk",
      fontSize: 16,
